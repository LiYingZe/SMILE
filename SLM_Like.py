...
def seq2seqTransformer(args,smallQueries,hugeQueries ):
    ...
    optimizer = optim.Adam(NNCls.parameters() )
...
if __name__== "__main__":
    ...
    parser.add_argument('--inferSampleNum', type=int, default= 64, help='Number of Inference Samples')
    parser.add_argument('--inferParrellism', type=int, default= 256, help='Inference Paralism')
    ...
    parser.add_argument('--IterSave', type=int, default= 5000, help='Number of Iter Saving Model and Eval')
    ...
    parser.add_argument('--CLS', type=int, default= 0, help='Train SMILE\'s Classifier')
